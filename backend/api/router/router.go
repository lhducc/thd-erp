...
func RegisterRoutes(router *gin.RouterGroup, db *gorm.DB) {
	...
	employeeUsecase := usecase.NewEmployeeBiz(db, userRepo, timesheetRepo, timesheetListRepo, departmentRepo)
...
func setupEmployeeRouters(adminRouter, userRouter, managerRouter *gin.RouterGroup, handler *handler.EmployeeHandler) {
	adminEmployeeRouter := adminRouter.Group("/employee")
	{
		...
		adminEmployeeRouter.GET("/active", handler.GetAllEmployeesActive())
	}
