...
type Employee struct {
	...
	Email       string    `gorm:"column:email;uniqueIndex;type:varchar(255);not null" json:"email" validate:"required,email"` // Dùng làm login_mail luôn
	Password    string    `gorm:"column:password;type:varchar(255);not null" json:"password"`
	FirstLogin  bool      `gorm:"column:first_login" json:"first_login"`
	RoleID      string    `gorm:"column:role_id;type:varchar(50)" json:"role_id"`
