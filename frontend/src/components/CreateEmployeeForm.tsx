...
return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className=" min-w-[1261px] p-6">
        ...
        <Form select {...form}>
          <form select onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                      ...
                      <FormItem>
                        ...
                        <FormControl>
                          ...
                          >
                            ...
                            <option value="VT0005">Lập trình viên</option>
                            <option value="VT0005">Quản lý</option>
                          </select>
                        </FormControl>
                        <FormMessage className="text-red-500 text-sm" />
                      </FormItem>
                      ...
                      <FormItem className="mt-[20px]">
                        ...
                        <FormControl>
                          ...
                          >
                            ...
                            <option value="PB0001">Công nghệ thông tin</option>
                            <option value="PB0001">Nhân sự</option>
                          </select>
                        </FormControl>
                        <FormMessage className="text-red-500 text-sm" />
                      </FormItem>
