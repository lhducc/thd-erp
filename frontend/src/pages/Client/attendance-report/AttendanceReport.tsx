...
const AttendanceReport = () => {
    ...
    <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
      <DialogContent className="bg-white p-6 rounded-lg max-w-md mx-auto">
        ...
        <div className="space-y-4">
          ...
          {detail.checkin_record?.image_URL && (
            <img src={detail.checkin_record.image_URL} alt="Check-in" />
          )}

          {detail.checkout_record?.image_URL && (
            <img src={detail.checkout_record.image_URL} alt="Check-out" />
          )}
  ...
  return (
    <div className="p-2 sm:p-4 max-w-4xl mx-auto">
                      ...
                      >
                        {(attendanceDetail.checkin_record && (
                          <span className="text-sm text-red-500">
                            {formatTime(
                              attendanceDetail.checkin_record.timestamp
                            ) || "--"}
                          </span>
                        ...
                        {(attendanceDetail.checkout_record && (
                          <span className="text-sm text-red-500">
                            {formatTime(
                              attendanceDetail.checkout_record.timestamp
                            )}
                          </span>
                        )) || <p className={`text-red-500`}>--</p>}
                      </div>
      ...
      {selectedDetail && <AttendanceDialog detail={selectedDetail} />}
    </div>
  );
};
