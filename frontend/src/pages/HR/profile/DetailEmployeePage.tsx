...
import {
  contractColumns,
  documentColumn,
} from "@/pages/HR/profile/columns.tsx";
...
const DetailEmployeePage = () => {
  ...
  if (isError || !employee)
    return <p>Không thể tải dữ liệu. Vui lòng thử lại.</p>;
    ...
    <div className="bg-white p-6 rounded-md w-[100%]">
      ...
      <div className="space-y-2">
        {[
          ...
          {
            label: "Giới tính",
            value: employee.gender === "male" ? "Nam" : "Nữ",
          },
          ...
          {
            label: "Văn phòng",
            value: employee.department?.office?.office_name,
          },
          ...
          <div
            key={index}
            className="flex justify-between w-full border-b-1 border-gray-400 py-2"
          >
