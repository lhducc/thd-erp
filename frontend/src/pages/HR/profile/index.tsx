    ...
    const ButtonCreate = () => {
        ...
        return (
            <div className="button-container flex items-center justify-center space-x-4 text-[17px]">
                <CreateEmployeeForm className="w-[1261px]" open={open} setOpen={setOpen}
                    ...
                    <div ref={filterRef}
                        ...
                        {["Văn phòng", "Phòng ban", "Chức vụ", "Vị trí"].map((filter, index) => (
                            <div key={index} className="mb-4">
                                ...
                                <div>
                                    <input type="checkbox" id={`filter-${index}-option1`}/> <label
                                    htmlFor={`filter-${index}-option1`}>Option 1</label>
                                    <br/>
                                    <input type="checkbox" id={`filter-${index}-option2`}/> <label
                                    htmlFor={`filter-${index}-option2`}>Option 2</label>
                                </div>
                            </div>
                        ))}
                        <button className="btn-filter bg-[#DB3B21] text-white py-2 px-4 rounded-full w-full">Lọc
                        </button>
                    </div>
                )}
            </div>
