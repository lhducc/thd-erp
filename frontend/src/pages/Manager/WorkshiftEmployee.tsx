      ...
      return employeeShifts
        .filter((shift: EmployeeWorkshift) => {
          try {
            ...
            const shiftDateString = `${shiftDate.getFullYear()}-${(
              shiftDate.getMonth() + 1
            )
              .toString()
              .padStart(2, "0")}-${shiftDate
              .getDate()
              .toString()
              .padStart(2, "0")}`;
      ...
      <DragDropContext onDragEnd={handleDragEnd} onDragStart={handleDragStart}>
        ...
        >
          <div className="min-w-max">
            {/* Header với các ngày */}
            <div className="flex">
              <div className="p-2 font-medium text-center sticky left-0 bg-white z-10 min-w-[200px] max-w-[200px]">
                Nhân viên
              </div>
              {monthDays.map((day, i) => (
                <div
