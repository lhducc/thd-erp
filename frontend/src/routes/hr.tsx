...
const SetupWorkScheduleRegister = lazy(() => import("@/pages/HR/checkin/wok-schedule-register/SetupWorkScheduleRegister"));
const SettingWorkScheduleAuto = lazy(() => import("@/pages/HR/checkin/work-schedule-auto/SettingWorkScheduleAuto"));
const SettingWorkScheduleRegister = lazy(() => import("@/pages/HR/checkin/wok-schedule-register/SettingWorkScheduleRegister"));
const ApproveAttendancePage = lazy(() => import("@/pages/HR/checkin/approve-attendance/page/ApproveAttendanceOverviewPage"));
const ApproveAttendanceDetailPage = lazy(() => import("@/pages/HR/checkin/approve-attendance/page/ApproveAttendanceDetailPage"));
const DocumentDetail = lazy(() => import("@/pages/documentDetailPage"));
const DecisionPage = lazy(() => import("@/pages/DecisionPage"));
const AttendanceManagementPage = lazy(() => import("@/pages/HR/checkin/AttendanceManagementPage"));
